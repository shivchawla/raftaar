import BackTester.getlatestprice
import BackTester.getlatesttradebar
...
function getlatesttradebar(security::Security)
    getlatesttradebar(algorithm.universe, security.symbol)
end

function getlatesttradebar(secid::Int64)
    getlatesttradebar(algorithm.universe, getsecurity(secid).symbol)
end

function getlatesttradebar(symbol::SecuritySymbol)
    getlatesttradebar(algorithm.universe, symbol)
end

function getlatesttradebar(ticker::String)
    getlatesttradebar(algorithm.universe, getsecurity(ticker).symbol)
end
