...
function setProfitTarget(profitTarget::Float64)
    __IllegalContextMessage(:setbenchmarkvalues, :ondata)
    setProfitTarget!(algorithm.tradeenv, profitTarget)
end
export setProfitTarget

function setStopLoss(stopLoss::Float64)
    __IllegalContextMessage(:setbenchmarkvalues, :ondata)
    setStopLoss!(algorithm.tradeenv, stopLoss)
end
export setStopLoss
...
function getresolution()
    return algorithm.tradeenv.resolution
end
...
function getStopLoss()
    algorithm.tradeenv.stopLoss
end
export getStopLoss

function getProfitTarget()
    algorithm.tradeenv.profitTarget
end
export getProfitTarget
