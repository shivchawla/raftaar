...
Security() = Security(SecuritySymbol(),"","","","", DateTime(1), DateTime(1), Dict{String,Any}())
Security(ticker::String; securitytype::String = "EQ", exchange::String="NSE", country::String="IN") =
                  Security(SecuritySymbol(0,ticker), "",
                            ...
                            DateTime(1), DateTime(1), Dict{String,Any}())

Security(ticker::String, detail::Dict{String,Any}; securitytype::String = "EQ", exchange::String="NSE", country::String="IN") =
                  Security(SecuritySymbol(0,ticker), "",
                            exchange, securitytype,
                            DateTime(1), DateTime(1), detail)

Security(ticker::String, detail::Dict{Any,Any}; securitytype::String = "EQ", exchange::String="NSE", country::String="IN") =
                  Security(SecuritySymbol(0,ticker), "",
                            exchange, securitytype,
                            DateTime(1), DateTime(1), todict(detail))

Security(id::Int64, ticker::String, name::String; exchange::String="NSE", country::String = "IN", securitytype::String = "EQ") =
          Security(SecuritySymbol(id, ticker), name, exchange, country, securitytype, DateTime(1), DateTime(1), Dict{String,Any}())

Security(id::Int64, ticker::String, name::String, detail::Dict{String,Any}; exchange::String="NSE", country::String = "IN", securitytype::String = "EQ") =
          Security(SecuritySymbol(id, ticker), name, exchange, country, securitytype, DateTime(1), DateTime(1), detail)
          ...
          Security(SecuritySymbol(id, ticker), name, exchange, country, securitytype, DateTime(1), DateTime(1), todict(detail))
...
#=Security(symbol::SecuritySymbol, securitytype::SecurityType) =
              Security(symbol, securitytype, "", DateTime(1),
                       DateTime(1))
